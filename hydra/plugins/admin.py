...
from hydra import BOTLOG, BOTLOG_CHATID, CMD_HELP
from hydra.hydraConfig import Var
from hydra.utils import admin_cmd, errors_handler, sudo_cmd
...
@hydra.on(admin_cmd(outgoing=True, pattern="setgpic"))
@hydra.on(sudo_cmd(outgoing=True, pattern="setgpic", allow_sudo=True))
@errors_handler
...
@hydra.on(admin_cmd("promote(?: |$)(.*)"))
@hydra.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@hydra.on(admin_cmd(outgoing=True, pattern="demote(?: |$)(.*)"))
@hydra.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@hydra.on(admin_cmd(pattern="(ban|unban) ?(.*)"))
@hydra.on(sudo_cmd(pattern="(ban|unban) ?(.*)", allow_sudo=True))
async def _(event):
...
@hydra.on(admin_cmd(pattern="pgs ?(.*)"))
@hydra.on(sudo_cmd(pattern="pgs ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@hydra.on(admin_cmd(outgoing=True, pattern="admins$"))
@errors_handler
...
@hydra.on(admin_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@hydra.on(sudo_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@hydra.on(admin_cmd(outgoing=True, pattern="kick(?: |$)(.*)"))
@hydra.on(sudo_cmd(outgoing=True, pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
...
@hydra.on(admin_cmd(outgoing=True, pattern="users ?(.*)"))
@errors_handler
