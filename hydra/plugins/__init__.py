...
from hydra import *
from hydra import ALIVE_NAME, bot, telever
...
TELEUSER = str(ALIVE_NAME) if ALIVE_NAME else "@HydraSupport"

tele = f"Hydra Version: {telever}\n"
tele += f"Log Group: {log}\n"
tele += f"Assistant Bot: {bots}\n"
tele += f"Lydia: {lyd}\n"
tele += f"Sudo: {sudo}\n"
tele += f"PMSecurity: {pm}\n"
tele += f"\nVisit @HydraSupport for assistance.\n"
telestats = f"{tele}"
